...
-- Script name: inserts.sql
   ...
   (1, 'Richard', '2020', 1, 0), (2, 'Ezinne', '2021', 0, 0), (3, 'Foxy P', '2020', 1, 0);
 ...
 -- Living Situation table inserts
   ...
   INSERT INTO PhDProgram (phd_program_id, student_phd_name, is_phd_track, phd_program_area, 
						   phd_school_1stchoice, phd_school_2ndchoice, phd_school_3rdchoice, accepted_to_1st, accepted_to_2nd, 
						   accepted_to_3rd, phd_attended, reason) 
	VALUES 
   (1, 'Ezinne', 1, 'Math', 'Stanford', 'Berkley', 'Texas A&M', 0,0,1, 'Texas A&M', 'Only school I got into'), 
   (2, 'Richard', 1, 'Math Education', 'Berkley', 'Stanford', 'Texas A&M', 1,1,1, 'Berkley', 'I always wanted to go here'), 
   (3, 'Foxy P',1, 'Applied Math', 'Texas A&M', 'Berkley', 'Stanford', 0,1,1, 'Stanford', 'I like the flowers there');
   ...
   INSERT INTO Student (student_id, student_name, student_email, student_phone, student_address, is_mentor, is_affiliate, livingsit_id, phd_id, college_id, received_scholarship, has_extracurricular) VALUES 
   (1, 'Ezinne', 'ezinne@gmail.com', 7659340265, '67 A street, Santa Barbara CA', 0, 0, 1, 1, 1, 1,1), 
   (2, 'Richard', 'richard@gmail.com', 6549346520, ' 23 B Street, Santa Clara CA', 0, 0, 2, 2, 1, 1,1), 
   (3, 'Foxy P', 'foxy@gmail.com', 2387456342, '87 C Street, San Jose CA', 0,1, 3, 3, 3, 0,0 );
   ...
   (2, 'parent loan', 10000, 2), 
   (3, 'unsubsidize loan', 5000, 3);
   ...
   INSERT INTO Occupation (occupation_id, occupation_type, is_full_time, extracurricular_id, student_occ_name) VALUES 
   (1, 'Secretary', 1, 2, 'Ezinne'), (2, 'Cashier', 0, NULL, 'Richard'), (3, 'Tutor', 0, NULL, 'Foxy P');
   ...
   (2, 'Shakira', 1, 'shakira@gmail.com', 6234891048, NULL, 'Cal Poly Pomona', 'Mathemathics'), 
   (3, 'Aretha Franklin', 1, 'afranklin@gmail.com', 3459087259, NULL, 'Fresno State', 'Mathemathics');
